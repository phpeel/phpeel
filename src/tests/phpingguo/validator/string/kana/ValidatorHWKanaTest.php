<?php
namespace Phpingguo\Tests\Phpingguo\Validator\String\Kana;

use Phpingguo\System\Validator\Options;
use Phpingguo\System\Validator\String\Kana\HalfWidthKana;

class ValidatorHWKanaTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testValidate($value, $expected, $options, $exception, $init)
    {
        ...
        $this->assertSame($expected, (new HalfWidthKana())->validate($value, $init($options)));
    }
}
